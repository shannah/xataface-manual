...
Use the `default_sort` property of the fields.ini file.

.Using the `default_sort` property in the fields.ini file to sort records in descending order on the date_posted field.
[source,ini]
----
default_sort=date_posted desc
----
